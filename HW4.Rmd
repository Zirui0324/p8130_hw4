...
The fitted model is **ln(totalcost) = 6.0449619  + 0.1757486ERvisits + 1.4921110comp_bin - 0.0221376age + 0.0055406duration**. As the covariate **gender** didn't make any significant difference to the model under a 5% confidence level, it should not be included along with other variables.
...
I would choose the MLR model, as the anova test told us that the coefficients of covariates comp_bin, age and duration of treatment were not 0 and thus should be considered when fitting a model to predict total cost.
